...
<body>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        <div class="row">
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url() . 'page/v_tugas' ?>">
    ...
    <div class="container">
        ...
        <div class="row justify-content-md-center">
            <div class="col-sm-32 col-sm-offset-0 col-lg-12 col-lg-offset-1 main">
                ...
                <a href="<?php echo base_url('page/tambah_tugas'); ?>" class="btn btn-success">Tambah Tugas</a>
                <hr />
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url('tugas/delete/' . $row->id_tugas); ?>" class="btn btn-danger">Hapus</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
