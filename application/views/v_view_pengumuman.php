    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li class="active"><?php echo $b['judul_pengumuman']; ?></li>
            </ol>
        </div>
        <!--/.row-->
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><?php echo $b['judul_pengumuman']; ?></h1>
                <hr />
                <img src="<?php echo base_url() . 'assets/images/' . $b['image_pengumuman']; ?>">
                <br />
