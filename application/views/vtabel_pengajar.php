...
<body>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        <div class="row">
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url() . 'page/tabel_pengajar' ?>">
        ...
        <div class="col-sm-9 col-sm-offset-7 col-lg-12 col-lg-offset-1 main">
            <div class="row">
                <h1 class="page-header">Data
                    ...
                    <br />
                    <button class="btn btn-success" onclick="add_pengajar()"><i class="glyphicon glyphicon-plus"></i> Tambah Pengajar</button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body form">
                    <form action="#" id="form" class="form-horizontal">
                        <input type="hidden" value="" name="id_pengajar" />
                        <div class="form-body">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            table = $('#table').DataTable({
                ...
                ajax: {
                    url: '<?php echo base_url('index.php/tabel_pengajar/ajax_list') ?>',
                    type: "POST"
                },
        ...
        function add_pengajar() {
            ...
            $('.modal-title').text('Add Pengajar'); // Set Title to Bootstrap modal title
        }
        ...
        function edit_pengajar(id) {
            ...
            $.ajax({
                url: "<?php echo base_url('index.php/tabel_pengajar/ajax_edit') ?>/" + id,
                type: "GET",
                dataType: "JSON",
                success: function(data) {
                    ...
                    $('.modal-title').text('Edit pengajar'); // Set title to Bootstrap modal title
        ...
        function save() {
            ...
            if (save_method == 'add') {
                url = "<?php echo base_url('tabel_pengajar/ajax_add') ?>";
            } else {
                url = "<?php echo base_url('tabel_pengajar/ajax_update') ?>";
            }
        ...
        function delete_pengajar(id) {
            if (confirm('Anda yakin ingin menghapus data ?')) {
                ...
                $.ajax({
                    url: "<?php echo base_url('tabel_pengajar/ajax_delete') ?>/" + id,
                    type: "POST",
                    dataType: "JSON",
                    success: function(data) {
        ...
        $('#import_form').on('submit', function(event) {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url('tabel_pengajar/import') ?> ",
                method: "POST",
